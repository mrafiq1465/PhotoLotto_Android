	...
	public void startCamera(){
		...
		try {
			...
			for(Camera.Size size : sizes) {
				...
				{
					minPictureSize = size;
				} else if (size.width == minPictureSize.width && size.height < minPictureSize.height) {
					minPictureSize = size;
				}
			}		
			Log.d("PhotoLotto", "Set size: " + minPictureSize.width + " x " + minPictureSize.height);
			parameters.setPictureSize(minPictureSize.width, minPictureSize.height);		
			
//			float ratio = (float)minPictureSize.width / (float)minPictureSize.height;
