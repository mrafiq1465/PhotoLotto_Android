...
public class EventModel {
	...
	protected Object clone() throws CloneNotSupportedException {
		...
		clone.setsEventType(this.sEventType);
		clone.setsTwitterMsg(this.sTwitterMsg);
		clone.setsFacebookUrl(this.sFacebookUrl);
		clone.setsHtmlBefore(this.sHtmlBefore);
		clone.setsName(this.sName);
		clone.setsImgThumb(this.sImgThumb);
		clone.setsImageOverlay1(this.sImageOverlay1);
		clone.setsImageOverlay2(this.sImageOverlay2);
		clone.setsImageOverlay3(this.sImageOverlay3);
		clone.setsImageOverlay4(this.sImageOverlay4);
		clone.setsImageOverlay5(this.sImageOverlay5);
		clone.setsCompanyName(this.sCompanyName);
		clone.setfDistance(this.fDistance);
		clone.setsShortDescription1(this.sShortDescription1);
		clone.setsShortDescription2(this.sShortDescription2);
		clone.setsFacebookMessage(this.sFacebookMessage);
		clone.setsHtmlAfter(this.sHtmlAfter);
		clone.setsTerms(this.sTerms);
		clone.setnNumberOfOverlay(this.nNumberOfOverlay);
		clone.setlId(this.lId);
		clone.setsPassword(this.sPassword);
